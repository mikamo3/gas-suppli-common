...
export declare const fetchSuppli: jest.Mock<Pick<import("../../src/model/Suppli").Suppli, "id" | "name" | "typeId" | "makerId" | "amountPerServing" | "servingUnit">[], []>;
...
export declare const fetchIntake: jest.Mock<Pick<import("../../src/model/Intake").Intake, "id" | "serving" | "timingId" | "typeId">[], []>;
export declare const updateIntakes: jest.Mock<any, any>;
declare const mockedDatastore: jest.Mock<Datastore, []>;
export declare const setFetchSuppliReturnValue: (value: Pick<import("../../src/model/Suppli").Suppli, "id" | "name" | "typeId" | "makerId" | "amountPerServing" | "servingUnit">[]) => void;
...
export declare const setFetchIntakeReturnValue: (value: Pick<import("../../src/model/Intake").Intake, "id" | "serving" | "timingId" | "typeId">[]) => void;
...
export declare const createSuppli: (id?: number, typeId?: number, makerId?: number, name?: string, amountPerServing?: number, servingUnit?: string) => Pick<import("../../src/model/Suppli").Suppli, "id" | "name" | "typeId" | "makerId" | "amountPerServing" | "servingUnit">;
...
export declare const createIntake: (id?: number, timingId?: number, typeId?: number, serving?: number) => Pick<import("../../src/model/Intake").Intake, "id" | "serving" | "timingId" | "typeId">;
