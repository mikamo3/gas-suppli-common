...
var MockDatastore_1 = require("mocks/datastore/MockDatastore");
...
describe("updateIntakes", function () {
    ...
    describe("任意の値が指定された場合", function () {
        beforeAll(function () {
            intakes = [
                MockDatastore_1.createIntake(1, 10, 30, 5),
                MockDatastore_1.createIntake(2, 11, 31, 6),
                MockDatastore_1.createIntake(3, 12, 32, 7)
            ];
        });
